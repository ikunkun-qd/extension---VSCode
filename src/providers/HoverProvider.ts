...
export class HoverProvider implements vscode.HoverProvider {
     ...
     * @returns Markdown字符串
     */
    private buildHoverContent(componentName: string, description: string): vscode.MarkdownString {
        ...
        const commandUri = vscode.Uri.parse(
            `command:componentDoc.showDocumentation?${encodeURIComponent(JSON.stringify([componentName]))}`
        );
